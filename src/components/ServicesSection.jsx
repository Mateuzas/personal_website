...
function ServicesSection() {
  ...
  const services = [
    {
      ...
      description:
        "Comprehensive security testing to identify vulnerabilities in your web applications using standard techniques.",
      fiverr: "", // You can add your Fiverr link here later
    },
    {
      title: "General Security Consulting",
      description:
        "Expert cybersecurity guidance to strengthen your overall security posture and protect your digital assets from threats.",
      fiverr: "", // You can add your Fiverr link here later
    },
    {
      title: "Landing Page Design",
      description:
        "Professional logo, favicon, and complete landing page design in Figma with mobile-responsive layouts and brand identity.",
      fiverr: "https://www.fiverr.com/s/jj1dWQ9",
    },
    {
      title: "Website Development",
      description:
        "Full-stack web development using React, Vite, and Tailwind CSS with professional hosting on Hostinger or GitHub Pages.",
      fiverr: "https://www.fiverr.com/s/jj1dWQ9",
    },
  ];
      ...
      case 1: // General Security Consulting - Simple lock
        return (
          ...
          >
            ...
            {/* Lock shackle */}
            <path
              d="M26 28V22C26 18.6863 28.6863 16 32 16C35.3137 16 38 18.6863 38 22V28"
              stroke={iconColor}
              strokeWidth="2"
              fill="none"
            />
  ...
  return (
    <motion.section
      id="services"
      className="w-full py-6 lg:py-24 bg-white"
    ...
    >
        ...
        >
          <div className="w-full flex flex-col justify-start items-center gap-3.5">
            ...
            <div className="w-full text-center">
              <span className="text-neutral-800 text-4xl font-bold font-['Work_Sans'] leading-10">
                Exploring My Technical{" "}
              </span>
              <span className="text-blue-600 text-4xl font-bold font-['Work_Sans'] leading-10">
                Expertise
              </span>
            </div>
            <div className="w-full text-center text-neutral-800 text-lg font-normal font-['Work_Sans'] leading-normal">
              From cybersecurity consulting to modern web development, I deliver
              comprehensive solutions that protect and enhance your digital
              presence
            </div>
          </div>
          ...
          <div className="w-full flex justify-center">
            <motion.div
              ...
              className="w-full max-w-sm p-7 rounded-[10px] flex flex-col justify-start items-start gap-2.5 bg-white outline outline-1 outline-offset-[-1px] outline-neutral-200"
              initial={{ opacity: 0, x: animationDirection * 50 }}
              animate={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.3, ease: "easeInOut" }}
            >
              {/* Icon */}
              <div className="w-full h-16 flex justify-start items-start mb-2">
                {getServiceIcon(currentServiceIndex, false)}
              </div>

              {/* Title */}
              <div className="w-full text-2xl font-bold font-['Work_Sans'] leading-loose text-black">
                {services[currentServiceIndex].title}
              </div>

              {/* Description */}
              <div className="w-full text-lg font-normal font-['Work_Sans'] leading-7 text-zinc-800">
          ...
          <div className="flex justify-center items-center gap-2">
            {services.map((_, index) => (
              <button
                key={index}
                onClick={() => {
                  setAnimationDirection(index > currentServiceIndex ? 1 : -1);
                  setCurrentServiceIndex(index);
                }}
                className={`w-3 h-3 rounded-full transition-colors duration-200 ${
                  index === currentServiceIndex ? "bg-blue-600" : "bg-gray-300"
                }`}
              />
            ))}
          </div>
      ...
      <div className="hidden lg:flex w-full px-5 lg:px-20 flex-col justify-start items-start gap-7">
        {/* Header Section */}
        <motion.div
